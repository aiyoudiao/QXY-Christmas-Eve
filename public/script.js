...
class World {
  ...
  addModel() {
    return new Promise((resolve) => {
      this.loaders.gltfLoader.load("./snowglobe-1.glb", (response) => {
        ...
        model.children.forEach((child) => {
          ...
          if (child.material?.name === "snow-base") {
            child.material.color = new THREE.Color(0xcd4535);
            child.material.emissive = new THREE.Color(0xc2282d);
  ...
  addLights() {
    ...
    // backLight
    this.backLight = new THREE.DirectionalLight(0xffb6c1, 2);
  ...
  loop() {
    ...
    if (this.snow) {
      ...
      if (
        ...
        this.snow.material.uniforms.previousActionTime.value =
          this.snow.material.uniforms.actionTime.value;
